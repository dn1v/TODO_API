...
export const readTasks = async (req: Request, res: Response): Promise<Response | void> => {
...
export const readTask = async (req: Request, res: Response): Promise<Response | void> => {
    try {
...
export const editTask = async (req: Request, res: Response): Promise<Response | void> => {
